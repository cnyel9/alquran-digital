  ...
  if (loading) {
    return (
      <div>
        <img
          src="/img/loading.png"
          className="mx-auto w-20 bg-none"
          alt="Loading..."
        />
      </div>
    );
  ...
  return (
    <div className={`flex justify-center items-center ${modeClass}`}>
      <div className="w-full max-w-3xl">
        <div
          className={`flex-col w-full p-5 rounded-md ${
        ...
        >
          ...
          <p className="font-[Amiri] text-2xl text-center">
            {surah.name.short}
          </p>
          ...
          <div className="mt-5">
            {surah.verses.map((verse, i) => (
              <div key={i} className="mb-4">
                ...
                <p className="text-right font-[Amiri] text-2xl">
                  {verse.text.arab}
                </p>
                <p className="text-right opacity-70">
                  {verse.text.transliteration.en}
                </p>
                <p className="text-right mt-2 opacity-50">
        ...
        <footer className="footer footer-center bg-emerald-400 text-base-content p-4">
          <aside className="text-center">
            <p className="font-medium">Made With ❤️ By Levi Setiadi</p>
          </aside>
        </footer>
      </div>
    </div>
